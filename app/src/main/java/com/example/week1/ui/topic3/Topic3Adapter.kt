...
class Topic3Adapter (var items : Array<Weather>) : RecyclerView.Adapter<Topic3Adapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Topic3Adapter.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.layout_weather_lists, parent, false)

        return ViewHolder(itemView)
    }

    // 전달받은 위치의 아이템 연결
    override fun onBindViewHolder(holder: Topic3Adapter.ViewHolder, position: Int) {
